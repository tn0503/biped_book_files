...
int16_t action[][12] = {
    ...
    { 90, 90, 90, 80, 90, 90, 90, 90, 80, 90, 90, 90}, //左体重
    { 90, 90, 90, 80, 90, 90, 90, 90, 80, 70, 70, 90}, //ステップ
    { 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90}, //イニシャル
    { 90, 90, 90,100, 90, 90, 90, 90,100, 90, 90, 90}, //右体重
    { 90,110,110,100, 90, 90, 90, 90,100, 90, 90, 90}  //ステップ
  };
uint8_t divide = 10;
uint8_t divCounter;
uint8_t keyFrame;
