...
int16_t rghtAction[][13] = {
  { 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 8},
  { 90, 90, 90, 80, 90, 90, 90, 90, 80, 90, 90, 90, 8}, //左重心
  { 90, 90, 90, 80, 90, 90, 90, 90, 80, 90, 90, 80, 8},
  {100, 90, 90,100, 90, 90, 90, 90,100, 90, 90, 90, 8}, //右重心
...
void loop() {
  ...
  // フレーム処理
  divCounter++;
  if(divCounter >= rghtAction[nextKeyFrame][12]) {
    divCounter = 0;
  ...
  // サーボ角度計算
  for(int i = 0; i < 12; i++) {
    tempAngles[i] = rghtAction[keyFrame][i] +
              int8_t((rghtAction[nextKeyFrame][i] - rghtAction[keyFrame][i])
               * divCounter / rghtAction[nextKeyFrame][12]);
  }
  // サーボ信号出力
  for(i = 0; i < 12; i++) {
